...
while True:
    ...
    # Pintar el submari
    raise NotImplementedError("Has de pintar el submari en el tauler") 

    # Registrar posicions del submarí
    if (datetime.datetime.now()-temps_inici).seconds > 0.2:          
        temps_inici=datetime.datetime.now()
        # Utilitza el mètode afegir_mesura per a registrar el nom, la x i la y del submarí 
        pass
